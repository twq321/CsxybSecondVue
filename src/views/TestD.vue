  ...
  export default {
    ...
    methods: {
      ...
      uploadAndDestroyRecord() {
        ...
        formData.append('file', fileOfBlob);  // 文件字段名保持为 'file'
        formData.append('loginText', this.username);  // 添加新的参数，值基于模板标题
  
        const uploadUrl = 'http://localhost:8888/csxyb_server_war/AudioLoginServlet';  // 新的 Servlet URL
